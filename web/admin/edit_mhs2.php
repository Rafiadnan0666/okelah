...
if (isset($_POST["sert"])) {
    ...
    $query = "UPDATE mahasantri SET nama_mhs='$nama', mentor_id='$mentor', gambar='$gambar' WHERE id=$id";
                                ...
                                <div class="form-group mb-4">
                                    <div class="form-group mb-4">
                                        <label class="text-center w-100">
                                            <div class="poto mb-3" style="background-image:url(../img/<?= $mh['gambar'] ?>);"></div>
                                        </label>
                                        <div class="input-group">
                                            <input type="file" id="gambar" name="gambar" class="filee form-control">
                                            <input type="submit" class="btn btn-outline-info" name="gambar" value="Upload">
                                        </div>
                                    </div>
                                    <div class="mb-3">
