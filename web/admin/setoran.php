...
$setor = mysqli_query($connect, "SELECT setoran.*, mahasantri.* 
FROM setoran INNER JOIN mahasantri ON setoran.mahasantri_id = mahasantri.id ORDER BY mahasantri_id ASC");
